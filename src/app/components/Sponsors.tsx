...
export function Sponsors() {
  const sponsors = {
    platinum: ['Siemens', 'ABB'],
    gold: ['Schneider Electric', 'CPFL Energia', 'WEG'],
    silver: ['Elektro', 'Cemig', 'TIM', 'Vivo', 'Claro'],
  };
    ...
    <section id="patrocinadores" className="py-20 bg-accent/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl mb-4">Patrocinadores</h2>
        ...
        <div className="space-y-12">
          <div>
            <div className="flex items-center justify-center gap-2 mb-8">
              ...
              <h3 className="text-2xl">Platina</h3>
              <Star size={24} className="text-yellow-500 fill-yellow-500" />
            </div>
